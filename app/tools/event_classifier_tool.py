...
k-NN anchor voting: each event type has 20+ real article title anchors.
Incoming articles are embedded and matched to the K nearest anchors via
weighted majority voting. Keyword boosters disambiguate close calls.
...
class EmbeddingEventClassifier:
    ...
    def classify_batch(
        ...
        logger.info(
            ...
            f"ambiguous={len(ambiguous_indices)}"
        )
